...
#categories: SUV, Jeep, Coupe, sedan, pickup truck, hatchback, wagon, convertible, minivan, sports car, cargo van, 
...
#ownerimages
targetFolder = '/home/hakhan/Google Drive/p2pCarRentalProject/AnalysisScripts/IntermediateData/carImages/APPNAME/'
for platform in studiedApps:
    tempFolder = targetFolder.replace('APPNAME',platform)
    csvPath = '/home/hakhan/Google Drive/p2pCarRentalProject/AnalysisScripts/IntermediateData/carImages/'+platform+'.xlsx'
    ...
    ws.cell(row=1, column=3, value='Type')#people count
    ws.cell(row=1, column=4, value='Color') #m=male, f= female, u=unknown pic, g=image of rental company
    # ws.cell(row=1, column=5, value='Make')
