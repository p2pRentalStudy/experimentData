...
fx = open(savePath+'15l-priceChangeDict.txt','r')
...
scriptName = '15m'
fig.savefig('plots/'+scriptName+'-changeFrequenctCDF.png') 
fig.savefig('plots/'+scriptName+'-changeFrequenctCDF.eps') 
