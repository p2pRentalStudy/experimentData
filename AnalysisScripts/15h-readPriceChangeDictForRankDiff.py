        ...
        if cityName != 'New York':
            ...
            for vehicleId in content:
                ...
                for i in range(len(myList)):
                    ...
                    currentRank = myList[i][2]
                    totalAvrg.append(currentVal)
                    # print(currentVal)
                    # time.sleep(10000)
                ...
                totalAvrg = np.average(totalAvrg)
                totalVehiclesPrice[platform].append((changes,changes2, totalAvrg, cityName, vehicleId, content[vehicleId]['constantVars']))

print(totalMeta)
savePath = '/home/hakhan/Google Drive/p2pCarRentalProject/AnalysisScripts/IntermediateData/15-output/'         
fx = open(savePath+'15h-priceChangeDict.txt','w')
