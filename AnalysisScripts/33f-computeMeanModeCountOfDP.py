                ...
                try:
                    ...
                    for recocrdDate in content[vehicleId]:
                        for dayDifference in content[vehicleId][recocrdDate]:
                            ...
                            # print(bookingPrice, vehicleId)

                            # time.sleep(1000)
                            rdcount +=1 
                            try:
                                v10 = platformCityVehiclePrices[cityName][vehicleId]
                            except:
                                platformCityVehiclePrices[cityName][vehicleId] = []
                           
                            platformCityVehiclePrices[cityName][vehicleId].append(float(bookingPrice))
...
for city in platformCityVehiclePrices:
    cityAvrg = []
    for vehicleId in platformCityVehiclePrices[city]:
        testList = platformCityVehiclePrices[city][vehicleId]
        lenavrg.append(len(testList))
        # pavrg = most_common(testList)
        # # print(pavrg, testList)
        # # time.sleep(1000)
        ...
        overUnder = len(set(testList))
        cityAvrg.append(round(overUnder,2))
        totalAverage.append(round(overUnder,2))
    # print(cityAvrg)
    print('\t', city, np.average(cityAvrg))
...
for city in platformCityVehiclePrices:
    ...
    for vehicleId in platformCityVehiclePrices[city]:
        ...
        overUnder = overUnder/len(testList)
        cityAvrg.append(round(overUnder,2))
        totalAverage.append(round(overUnder,2))
    # print(cityAvrg)
    print('\t', city, np.average(cityAvrg))
