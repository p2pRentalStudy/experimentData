...
for platform in studiedApps:
    ...
    for fileName in filenames:
        ...
        if cityName != 'New York':
                ...
                for i in range(0, len(totalDates)):
                    ...
                    for vehicleId in content[keyDate]:
                        try:
                            ...
                            try:
                                val = cityVehiclePricesDict[vehicleId][newKey]
                            except:
                                cityVehiclePricesDict[vehicleId][newKey] = []
                            ...
                            cityVehiclePricesDict[vehicleId][newKey].append(round(bookingPrice,2))
            ...
            savePath = '/home/hakhan/Google Drive/p2pCarRentalProject/AnalysisScripts/IntermediateData/13b-output/'+platform+'/'         
