...
attribute = 'numberOfMultiplicity'
    ...
    for fileName in filenames:
        ...
        if 1:
            ...
            for id in content2:
                # print(content[id])
                # time.sleep(1000000)
                for date in content2[id]:
                    car = content2[id][date]
                    ownerID = content2[id][date]['ownerID']
                    try:
                        val = ownerDict[ownerID]
                    except:
                        ownerDict[ownerID] = {}
            ...
            for i in range(0, len(totalDates)):
                ...
                for id in content[date]:
                    ...
                    try:
                        ...
                        bookingPrice = len(ownerDict[carObj2[checkKey]].keys())
