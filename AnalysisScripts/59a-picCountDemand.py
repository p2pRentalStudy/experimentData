    ...
    for cityName in analyzedData[platform]:
        if cityName != 'New York':
            ...
            for carId in analyzedData[platform][cityName]:
                ...
                dates.sort()
                numberOfImages = carObj[dates[0]]['numberOfImages']
                ...
                if experimentTripsVehicle > -1:
                    try:
                        ...
                        colorVehicleTripsDict[platform][cityName][str(numberOfImages)]['trips'].append(round(experimentTripsVehicle,2))
                    except:
                        pass
...
fx = open('vpicsNumberToTrips.txt','w')
