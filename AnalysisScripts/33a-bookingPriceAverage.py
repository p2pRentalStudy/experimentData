                ...
                for i in range(0, len(totalDates)):
                    ...
                    for vehicleId in content[keyDate]:
                        try:
                            ...
                            #     bookingPrice = round(bookingPrice*mulFactor,2)
                            # if bookingPrice < 22:
                            #     bookingPrice = random.randrange(20,45)
                            cityVehiclePricesDict[vehicleId][startDate][dayDifference] = round(bookingPrice,2)
                           
                            # print(vid, cityServiceCat[platform][cityName][str(vid)])
                            # time.sleep(1000)
                            ...
                            # print(vehicleId, cityServiceCat[platform][cityName].keys())
                            # time.sleep(1000)
                            ...
                            # print(keyDate,cityVehiclePricesDict)
                            # time.sleep(1000)
                    # cityVehiclePricesDict
