...
for platform in studiedApps:
    ...
    x = data = platformData[platform]
    y = data
    x = [1,2,3,4,5,6]
    y = np.cumsum(data)
    plt.plot( x, y, color=pcolor, label=plabel)
...
plt.xticks([1, 2, 3, 4, 5,6], ['1','2','3','4','5','5+'])
...
plt.title('Trips Percentage CDF against Multiplicity', fontsize=13)
